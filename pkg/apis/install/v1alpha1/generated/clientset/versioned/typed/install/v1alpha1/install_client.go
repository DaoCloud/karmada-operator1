...
import (
	...
	"github.com/daocloud/karmada-operator/pkg/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type InstallV1alpha1Interface interface {
	RESTClient() rest.Interface
	KarmadaDeploymentsGetter
}

// InstallV1alpha1Client is used to interact with features provided by the install.karmada.io group.
type InstallV1alpha1Client struct {
	restClient rest.Interface
}

func (c *InstallV1alpha1Client) KarmadaDeployments() KarmadaDeploymentInterface {
	return newKarmadaDeployments(c)
}
