...
func (in *KarmadaResourceSummary) DeepCopyInto(out *KarmadaResourceSummary) {
	*out = *in
	...
	if in.WorkLoadSummary != nil {
		...
		*out = make(map[string]*Statistic, len(*in))
		for key, val := range *in {
			var outVal *Statistic
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
...
func (in *ResourceSummary) DeepCopyInto(out *ResourceSummary) {
	*out = *in
	...
	if in.ClusterResource != nil {
		...
		*out = make(map[string]clusterv1alpha1.ResourceSummary, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Statistic) DeepCopyInto(out *Statistic) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Statistic.
func (in *Statistic) DeepCopy() *Statistic {
	if in == nil {
		return nil
	}
	out := new(Statistic)
